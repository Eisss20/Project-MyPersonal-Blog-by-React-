...
function HeroSection() {
  return (
    <main className=" py-10 xl:pl-10  bg[#F9F8F6] flex flex-col justify-center  mx-auto  ">
      <div className=" flex flex-col xl:flex-row items-center xl:pl-10">
        <article>
          ...
          <section className=" bg[#F9F8F6]">
            <h2 className=" text-center  xl:text-right font-light text-lg ">
              {" "}
